      ...
      setCases([
        {
          ...
          urgency: "High",
          location: "Hyderabad",
          description: "Citizen needs immediate guidance regarding domestic violence issues. They require legal and emotional support, including police assistance and safe shelter options.",
    ...
    <div className="w-full">
      <div className="bg-purple-900 rounded-2xl p-6 sm:p-10 mb-8">
        ...
        <p className="text-gray-200 text-base sm:text-lg">
          Cases that have been requested to your NGO
        </p>
          ...
          <div className="bg-white w-full max-w-4xl rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <div className="p-6 overflow-y-auto flex-1">
              ...
              {selectedCase.description && (
                <div className="mt-6">
                  <h4 className="font-bold text-purple-700 border-b pb-2 mb-3">Description</h4>
