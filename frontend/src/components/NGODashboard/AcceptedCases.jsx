...
import { FiFileText, FiUser, FiMapPin, FiCalendar, FiEye, FiMessageSquare, FiX } from "react-icons/fi";
...
export default function AcceptedCases() {
      ...
      setCases([
        {
          id: 1,
          caseNumber: "CASE-002",
          caseTitle: "Women Safety Support",
    ...
    return (
      <div className="w-full flex items-center justify-center py-12">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading accepted cases...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="w-full">
      <div className="bg-purple-900 rounded-2xl p-6 sm:p-10 mb-8">
        <h1 className="text-2xl sm:text-4xl font-bold text-white mb-2">Accepted Cases</h1>
        <p className="text-gray-200 text-base sm:text-lg">
          Cases that your NGO has accepted
        </p>
        <div className="mt-4 flex items-center gap-4">
          <div className="bg-white/10 rounded-lg px-4 py-2">
            <span className="text-white text-sm">Total Accepted: </span>
      ...
      {cases.length === 0 ? (
        <div className="bg-white rounded-2xl shadow-lg p-12 text-center max-w-2xl mx-auto">
          ...
          <h3 className="text-xl font-semibold text-gray-700 mb-2">No Accepted Cases</h3>
          <p className="text-gray-500">
            Your NGO hasn't accepted any cases yet.
          </p>
        </div>
      ) : (
        <div className="space-y-4">
          {cases.map((c) => (
            <div
              key={c.id}
              className="bg-white rounded-xl border border-gray-200 hover:border-purple-300 hover:shadow-md transition-all duration-300"
            >
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="p-2 text-purple-600 bg-purple-50 rounded-lg hover:bg-purple-100 transition cursor-pointer"
                      title="View Details"
                    >
      ...
      {selectedCase && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white w-full max-w-4xl rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
            <div className="bg-gradient-to-r from-purple-700 to-purple-900 p-6 flex justify-between items-start">
              <div>
            ...
            <div className="p-6 overflow-y-auto flex-1">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h4 className="font-bold text-purple-700 border-b pb-2">Case Information</h4>
                ...
                <div className="space-y-4">
                  <h4 className="font-bold text-purple-700 border-b pb-2">Citizen Details</h4>
