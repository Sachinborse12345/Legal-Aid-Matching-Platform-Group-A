                  ...
                  <div className="flex gap-2">
                    ...
                    {!lawyer.isApproved && (
                      <button
                        ...
                        className="text-[9px] font-black uppercase tracking-widest bg-[#D4AF37] text-black px-4 py-1.5 rounded-lg hover:bg-[#c5a059] transition-all shadow-xl shadow-[#D4AF37]/10"
                      >
                        Approve
                      </button>
                    )}
