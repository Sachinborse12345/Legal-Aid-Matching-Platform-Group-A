...
export default function LawyerAnalytics({ profile }) {
    ...
    const fetchAnalytics = async () => {
        ...
        try {
            setLoading(true);
            const response = await axios.get(`${API_BASE_URL}/lawyers/${profile.id}/analytics`);
    ...
    return (
        <div className="space-y-6 animate-fade-in p-4">
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-serif font-bold text-gray-900 dark:text-white">Lawyer Analytics Dashboard</h2>
