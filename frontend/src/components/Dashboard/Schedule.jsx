                                ...
                                {hasAppts && !isSelected && (
                                    <div className="absolute bottom-4 flex gap-1">
                                        {appts.slice(0, 3).map((_, idx) => (
                                            <div key={idx} className="w-1.5 h-1.5 bg-[#D4AF37] rounded-full shadow-[0_0_8px_#D4AF37]"></div>
                                        ))}
                                    </div>
                                )}
                            </button>
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full bg-gray-50 dark:bg-[#0a0a0a] border border-gray-200 dark:border-[#222] rounded-2xl p-5 text-[11px] font-bold tracking-widest text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-700 focus:border-[#D4AF37] outline-none transition-all"
                    ...
                    <div className="bg-white dark:bg-gradient-to-br dark:from-[#1a1a1a] dark:to-[#0f0f0f] rounded-[3rem] border border-gray-200 dark:border-[#222] p-10 shadow-2xl transition-colors">
                        ...
                        <div className="grid grid-cols-2 gap-6 mt-10">
                            <div className="bg-gray-50 dark:bg-[#151515] p-6 rounded-3xl border border-gray-100 dark:border-[#222]">
                                <p className="text-[9px] font-black text-gray-400 dark:text-gray-600 uppercase tracking-widest transition-colors">Active</p>
                                <p className="text-2xl font-bold text-gray-900 dark:text-white mt-2 font-serif transition-colors">{getAppointmentsForDate(selectedDate).length}</p>
                            </div>
                            <div className="bg-gray-50 dark:bg-[#151515] p-6 rounded-3xl border border-gray-100 dark:border-[#222]">
                            ...
                            getAppointmentsForDate(selectedDate).map((appt) => (
                                <div key={appt.id} className="p-8 rounded-[2rem] bg-gray-50 dark:bg-[#111] border border-gray-100 dark:border-[#222] hover:border-[#D4AF37]/40 transition-all group relative">
                                    <div className="flex justify-between items-start mb-6">
                                        ...
                                        <span className={`text-[9px] font-black px-4 py-1.5 rounded-full uppercase tracking-tighter ${appt.status === 'CONFIRMED' ? 'bg-emerald-500/10 text-emerald-400' : 'bg-[#D4AF37]/10 text-[#D4AF37]'
                                            }`}>
                                            {appt.status}
                                        </span>
                                    </div>
