...
export default function Home({ user }) {
  ...
  useEffect(() => {
    ...
    if (
      !ecosystemIsDeleting &&
      ecosystemTypingText.length < currentMessage.length
    ) {
      // Typing
      timeout = setTimeout(() => {
        setEcosystemTypingText(
          currentMessage.substring(0, ecosystemTypingText.length + 1),
        );
      }, 120);
    } else if (
      !ecosystemIsDeleting &&
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6 max-w-5xl mx-auto">
          ...
          <div className="flex gap-6">
            <Link
              to="/register"
              className="px-8 py-4 bg-[#D4AF37] text-black font-bold uppercase tracking-widest hover:bg-[#c5a059] transition-all transform hover:-translate-y-1 shadow-[0_0_20px_rgba(212,175,55,0.3)]"
            >
              Get Started
            </Link>
            <Link
              to="/about"
              className="px-8 py-4 border border-[#D4AF37] text-[#D4AF37] font-bold uppercase tracking-widest hover:bg-[#D4AF37] hover:text-black transition-all transform hover:-translate-y-1"
            >
              Learn More
            </Link>
          </div>
      ...
      <section className="relative py-24 bg-white dark:bg-[#111111] transition-colors">
        <div className="container mx-auto px-6">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 text-center max-w-4xl mx-auto leading-relaxed mb-16 font-light transition-colors">
            ...
            violence, and discrimination. Our mission is to bring{" "}
            <span className="text-[#D4AF37] font-medium">
              citizens, lawyers, and NGOs
            </span>{" "}
            together.
          </p>
            ...
            {[
              {
                ...
                desc: "We help individuals who were unfairly detained connect with immediate legal support.",
                icon: "⚖️",
              },
              {
                title: "Domestic Violence",
                desc: "Survivors deserve protection. We connect them with NGOs and trusted legal experts.",
                icon: "💚",
              },
              {
                title: "Human Rights",
                desc: "From discrimination to violence — we support communities fighting for their dignity.",
                icon: "🛑",
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="group p-8 rounded-none border border-gray-100 dark:border-[#333] bg-gray-50 dark:bg-[#1a1a1a] hover:border-[#D4AF37] transition-all duration-300 hovered-card relative overflow-hidden"
              >
                ...
                <h3 className="text-2xl font-bold text-[#D4AF37] mb-4 font-serif">
                  {item.title}
                </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="relative group overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-0 left-0 p-8 z-20 w-full bg-gradient-to-t from-black to-transparent">
                <h3 className="text-3xl font-bold text-[#D4AF37] mb-2 font-serif">
                  Citizens
                </h3>
                ...
                <Link
                  to="/register"
                  className="inline-flex items-center text-[#D4AF37] font-bold uppercase tracking-widest text-sm hover:text-white transition-colors"
                >
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white font-serif transition-colors">
                AdvoCare
              </h2>
            </div>
          ...
          <div>
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6 uppercase tracking-wider transition-colors">
              Quick Links
            </h3>
            <ul className="space-y-3 text-sm">
              <li>
                <Link className="hover:text-[#D4AF37] transition-colors" to="/">
                  Home
                </Link>
              </li>
              <li>
            ...
            <div className="flex space-x-4">
              {["Twitter", "LinkedIn", "Instagram"].map((social) => (
                <a
                  key={social}
                  href="#"
                  className="w-10 h-10 border border-gray-200 dark:border-[#333] flex items-center justify-center rounded-full hover:bg-[#D4AF37] hover:text-white dark:hover:text-black hover:border-[#D4AF37] transition-all transition-colors"
                >
                  {social[0]}
                </a>
              ))}
